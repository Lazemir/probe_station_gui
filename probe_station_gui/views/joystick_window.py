...
class JoystickWindow(JoystickFeedrateMixin, QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None) -> None:
        ...
        self.up_button = QPushButton("в†‘", self)
        self.left_button = QPushButton("в†ђ", self)
        self.right_button = QPushButton("в†’", self)
        self.down_button = QPushButton("в†“", self)
        ...
        self.rotate_negative_button = QPushButton("в†є", self)
        self.rotate_positive_button = QPushButton("в†»", self)
