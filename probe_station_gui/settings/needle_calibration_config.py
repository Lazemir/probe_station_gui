...
LCR_METER_TYPE_KEITHLEY_2400 = "keithley_2400"
...
LCR_METER_TYPE_LABELS: dict[str, str] = {
    ...
    LCR_METER_TYPE_KEITHLEY_2400: "Keithley 2400",
...
def _default_needle_calibration_config(
    ...
    return NeedleCalibrationConfig(
        **_needle_calibration_default_fields(defaults),
...
def _needle_calibration_default_fields(
    defaults: NeedleCalibrationDefaults | NeedleCalibrationSettings,
) -> dict[str, object]:
    return {
